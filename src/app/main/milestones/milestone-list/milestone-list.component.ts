...
export class MilestoneListComponent implements OnInit {
 ...
 /**
   ...
   */
  ngOnInit(): void {
      this.dataSource = new FilesDataSource(this._milestoneService, this.paginator, this.sort);
  ...
  deleteMilestone(milestone): void {
      ...
      this.confirmDialogRef.afterClosed().subscribe(result => {
          if (result) {
              ...
              this._milestoneService.deleteItemById(milestone.id).subscribe((response: any)  => {
                  // Show the success message
                  this._matSnackBar.open('Record Deleted', 'OK', {
                      verticalPosition: 'top',
                      duration: 3000
                  });
                  this._milestoneService.getItems();
              });
          }
...
export class FilesDataSource extends DataSource<any>
{
  ...
  constructor(
      ...
      this.filteredData = this._milestoneService.items;
  }
  ...
  connect(): Observable<any[]> {
      const displayDataChanges = [
          this._milestoneService.onItemsChanged,
      ...
      return merge(...displayDataChanges)
          .pipe(
              map(() => {
                  let data = this._milestoneService.items.slice();
