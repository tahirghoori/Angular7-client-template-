...
export class FeatureListComponent implements OnInit {
 ...
 /**
   ...
   */
  ngOnInit(): void {
      this.dataSource = new FilesDataSource(this._featureService, this.paginator, this.sort);
  ...
  deleteFeature(feature): void {
      ...
      this.confirmDialogRef.afterClosed().subscribe(result => {
          if (result) {
              ...
              this._featureService.deleteItemById(feature.id).subscribe((response: any)  => {
                  // Show the success message
                  this._matSnackBar.open('Record Deleted', 'OK', {
                      verticalPosition: 'top',
                      duration: 3000
                  });
                  this._featureService.getItems();
              });
          }
...
export class FilesDataSource extends DataSource<any>
{
  ...
  constructor(
      ...
      this.filteredData = this._featureService.items;
  }
  ...
  connect(): Observable<any[]> {
      const displayDataChanges = [
          this._featureService.onItemsChanged,
      ...
      return merge(...displayDataChanges)
          .pipe(
              map(() => {
                  let data = this._featureService.items.slice();
